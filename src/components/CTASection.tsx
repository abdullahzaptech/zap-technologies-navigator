    ...
    <section className="relative py-28 sm:py-36 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute top-12 left-[10%] h-24 w-24 rounded-2xl border border-primary-foreground/10 bg-primary-foreground/5 backdrop-blur-sm"
        />
        <motion.div
          animate={{ y: [0, 20, 0], rotate: [0, -8, 0] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
          className="absolute bottom-16 right-[8%] h-32 w-32 rounded-full border border-primary-foreground/10 bg-primary-foreground/5 backdrop-blur-sm"
        />
        <motion.div
        ...
        <motion.div
          ...
          className="absolute bottom-1/4 left-[25%] h-20 w-20 rounded-full border border-primary-foreground/8 bg-primary-foreground/[0.03]"
        />
      </div>
      ...
      <div className="container px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-primary-foreground/70 max-w-xl mx-auto mb-10"
          >
            Transform your ideas into powerful digital solutions. Book a free consultation with our experts today.
          </motion.p>
