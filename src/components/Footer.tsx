      ...
      <div className="container px-4 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <img src={zapLogo} alt="Zap Technologies" className="h-8 mb-4 brightness-0 invert" />
            ...
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-background/10 text-background/40 hover:text-accent hover:border-accent/30 transition-colors"
                >
                  {s.icon}
                </a>
              ))}
